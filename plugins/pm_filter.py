...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🎖 𝗠𝗮𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🎖', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്നതിൽ ഉണ്ടോ?👇.

ഉണ്ടെങ്കിൽ അതിൽ ക്ലിക്ക് ചെയ്യുക.

ഇല്ലങ്കിൽ സ്പെല്ലിംഗ് ഗൂഗിളിൽ നോക്കി ഒന്നോടെ വർഷവും കൂട്ടി ടൈപ്പ് ചെയ്യുക👇", reply_markup=InlineKeyboardMarkup(btn))
